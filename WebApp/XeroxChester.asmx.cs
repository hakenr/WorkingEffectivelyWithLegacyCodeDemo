...
{
    /// <summary>
    /// Summary description for XeroxChester
    /// </summary>
    ...
    public class XeroxChester : System.Web.Services.WebService
    {
        ...
        public string Create(string user, string password, string Migros_Cagri_No, string Cihaz_Seri_No, string Magaza_Kodu, string Cagri_Ilgilisi, string Cagri_Durum_Kodu, string Magaza_Telefonu, string Cagri_Aciklamasi, System.DateTime Cagri_Acilis_Tarih_Saati)
        {
            ...
            {
                // REQUIRED FIELDS
                if (Migros_Cagri_No == "") { throw new Exception("Migros_Cagri_No gerekli"); }
                if (Cihaz_Seri_No == "") { throw new Exception("Cihaz_Seri_No gerekli"); }
        ...
        public static void CheckNotificationNumber(int dbCallID) {
        ...
        public static void PrepareAndSendUpdateNotification(int oldServiceCallDBID, int newServiceCallDBID) {
        ...
        private static String ExtractContactPersonName(String Cagri_Ilgilisi)
        {
            if (!Cagri_Ilgilisi.Contains("(")) {
                return Cagri_Ilgilisi;
            }

            String[] contactPersonParts = Cagri_Ilgilisi.Split(new char[] { ' ' });
        ...
        private static String CreateTitle(String Magaza_Telefonu, String Cagri_Aciklamasi)
        {
            String title = Magaza_Telefonu + ", " + Cagri_Aciklamasi;
            title = title.Substring(0, Math.Min(40, title.Length));
            return title;
        }

        private static String CreateTitle(String prefix, String Magaza_Telefonu, String Cagri_Aciklamasi) {
            String title = prefix + ", " + Magaza_Telefonu + ", " + Cagri_Aciklamasi;
            title = title.Substring(0, Math.Min(40, title.Length));
            return title;
        }

        private static String CreateDescription(String Cagri_Aciklamasi, String contactPersonName, String Magaza_Telefonu, String Magaza_Kodu)
        {

            String description = Cagri_Aciklamasi + "\n" +
